...
class ServerSettings extends javax.swing.JFrame{
    ...
    private void butt_okActionPerformed(ActionEvent evt)
    {
        this.setVisible(false);
        
    }
    private void butt_cancelActionPerformed(ActionEvent evt)
    {
        this.setVisible(false);
        this.tf_ip.setText("192.168.43.30");
        this.tf_port.setText("12345");
    }
